...
#SBATCH -o Logs_FCY1_25-12-23/FCY1_300_final-%j.log
#SBATCH -c 1
...
/project/chlandry/users/siaub8/Reads_analysis.py --id $SLURM_ARRAY_TASK_ID --in /project/chlandry/users/siaub8/FC_300_SA --ref ref_F3F4_300_trimmed.fa --pre FCY1 --nested True --info Libs_info_300.csv --min_len 310 --max_len 345 --out FCY1_300_final_25-12-23
